...
return [
    ...
    */
    'auth' => [
        ...
        'providers' => [
            ...
            //     'driver' => 'eloquent',
            //     'model'  => App\Models\SysAdmin::class,
            //     'controller' => App\Admin\Controllers\api\AuthController::class,
    ...
    */
    'database' => [
        ...
        'users_table' => 'sys_admins',
        'users_model' => App\Models\SysAdmin::class,
    ...
    */
    'extensions' => [
        'api-tester' => [
            ...
            'provider_retriever' => function ($id) {
                return \App\Models\Provider::find($id);
            },
        ]
